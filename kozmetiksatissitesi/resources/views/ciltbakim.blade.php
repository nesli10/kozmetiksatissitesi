				...
				<div class="col-lg-4 col-md-6 text-center strawberry">
					<div class="single-product-item">
						<div class="product-image">
							<a href=""><img src="{{ asset('assets/fotolar') }}/{{ $value->foto }}" alt=""></a>
						</div>
						...
						@if($value->stok_adedi==0)
						<button type="button" class="cart-btn" name="addToChart" disabled><i class="fas fa-shopping-cart"></i> ürün tükendi
						</button>
						@endif
						<div style="margin-top: 5px;">
							<form action="{{url('urunDetay')}}" method="GET">
								@csrf
								<input type="hidden" value="{{$value->id}}" name="urun_id">
								<button type="submit" class="cart-btn" name="incele"><i class="fas fa-shopping-cart"></i>incele</button>
							</form>
						</div>
					</div>
				</div>
